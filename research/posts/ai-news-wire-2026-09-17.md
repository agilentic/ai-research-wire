---
title: "AI News Wire — 2026-09-17"
description: "Automated AI news brief from Google DeepMind Blog, Hugging Face Blog, MIT News AI, OpenAI News, arXiv cs.AI. Newest source item: 2026-09-17."
date: "2026-09-17"
...
- **Source:** arXiv cs.AI · **Published:** 2026-09-17
- **Feed summary:** arXiv:2609.17631v1 Announce Type: new Abstract: AI-assisted claims can appear authoritative when
evidence, analysis, human authorization, presentation, and correction history refer to different
states. Provenance, attestation, and transparency expose history but alone do not…

### 2. [EvolveTrade: Experience-Driven Policy Refinement for Self-Evolving LLM Trading Agents](https://arxiv.org/abs/2609.17632)
- **Source:** arXiv cs.AI · **Published:** 2026-09-17
- **Feed summary:** arXiv:2609.17632v1 Announce Type: new Abstract: Large language model (LLM) trading agents can
combine market data, news, and executable analysis, but their behavior is often controlled by
static hand-written tool-use policies that are fixed before deployment. This limits their…

### 3. [One Color Preprocessing Improves DSATUR](https://arxiv.org/abs/2609.17633)
- **Source:** arXiv cs.AI · **Published:** 2026-09-17
- **Feed summary:** arXiv:2609.17633v1 Announce Type: new Abstract: The Graph Coloring Problem (GCP) is NP-hard and
DSATUR stands as one of the fastest heuristics for it despite producing colorings that typically
use more colors than state-of-the-art coloring algorithms. We propose SSLD…
...
- **Source:** arXiv cs.AI · **Published:** 2026-09-17
- **Feed summary:** arXiv:2609.17635v1 Announce Type: new Abstract: City pedestrian counting systems now feed
